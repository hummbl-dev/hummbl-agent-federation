...
version: 1.0.0
metadata: {"openclaw":{"nix":{"plugin":"github:hummbl-dev/hummbl-agent?dir=skills/DE-decomposition/de3-modularization","systems":["aarch64-darwin","x86_64-linux"]}}}
---
...
```bash
openclaw-registry install hummbl-agent/de3-modularization
```
